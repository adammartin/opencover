...
namespace OpenCover.Framework
{
    ...
    public class CommandLineParser : CommandLineParserBase, ICommandLine
    {
            ...
            : base(arguments)
        {
            ...
            MethodExclusionFilters = new List<string>();
        ...
        public string Usage()
        {
            ...
            builder.AppendLine("    [-excludemethods:<method>]");
            builder.AppendLine("    [-excludebyfile:<filter>[;<filter>][;<filter>]]");
            builder.AppendLine("    [-excludelambdaautogeneratedbranches]");
            ...
            foreach (var key in ParsedArguments.Keys)
            {
                ...
                switch(lower)
                {
                    ...
                    case "excludeintermediatelanguagecondition":
                        ...
                        break;
                    case "excludelambdaautogeneratedbranches":
                        ExcludeLambdaAutoGeneratedBranches = true;
                        break;
                    case "excludemethods":
                        MethodExclusionFilters = GetArgumentValue("excludemethods").Split(';').ToList();
                        break;
                    case "hideskipped":
        ...
        /// </summary>
        public List<string> MethodExclusionFilters { get; private set; } 
        ...
        /// <summary>
        /// Exclude Lambda Auto Generated Branches
        /// </summary>
        public bool ExcludeLambdaAutoGeneratedBranches { get; private set; }
    }
