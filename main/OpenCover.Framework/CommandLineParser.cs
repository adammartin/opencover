...
namespace OpenCover.Framework
{
    ...
    public class CommandLineParser : CommandLineParserBase, ICommandLine
    {
            ...
            : base(arguments)
        {
            ...
            IntermediateLanguageBranchExclusionFilters = new List<string>();
            IntermediateLanguageConditionExclusionFilters = new List<string>();
        ...
        public string Usage()
        {
            ...
            builder.AppendLine("    [-excludeintermediatelangaugebranch:<interface>::<method>::position1[, position2[, position3]]");
            builder.AppendLine("    [-excludeintermediatelanguagecondition:<class>::<method>");
            ...
            builder.AppendLine("Intermediate Language Exclusions:");
            builder.AppendLine("    These exclusions are intended to provide a mechanism to exclude auto generated branches");
            builder.AppendLine("    A fundamental understanding of Intermediate Language (IL) is expected.");
            builder.AppendLine("    -excludeintermediatelangaugebranch option allows you to exclude 'n' position branches that are autogenerated");
            builder.AppendLine("        The filter will be applied to classes which implement given <interface> and in the supplied <method>");
            builder.AppendLine("        EXAMPLE: System.Runtime.CompilerServices.IAsyncStateMachine::MoveNext::0,1 will exclude");
            builder.AppendLine("            The first and second branches in the method <MoveNext>in classes");
            builder.AppendLine("            which implement <System.Runtime.CompilerServices.IAsyncStateMachine>");
            builder.AppendLine("    -excludeintermediatelanguagecondition option allows you to exclude a branch that is initiated by a call to");
            builder.AppendLine("        any class that starts with <class> and is calling <method>");
            builder.AppendLine("        EXAMPLE: System.Runtime.CompilerServices.TaskAwaiter::get_IsCompleted will exclude");
            builder.AppendLine("            a branch that is initiated by call to System.Runtime.CompilerServices.TaskAwaiter::get_IsCompleted");
                ...
                switch(lower)
                {
                    ...
                    case "excludebyfile":
                        FileExclusionFilters = GetArgumentValue("excludebyfile")
                            .Split(';').ToList();
                        break;
                    case "excludeintermediatelangaugebranch":
                        IntermediateLanguageBranchExclusionFilters = GetArgumentValue("excludeintermediatelangaugebranch")
                            .Split(';').ToList();
                        break;
                    case "excludeintermediatelanguagecondition":
                        IntermediateLanguageConditionExclusionFilters = GetArgumentValue("excludeintermediatelanguagecondition").Split(';').ToList();
                        break;
                    case "hideskipped":
        ...
        /// <summary>
        /// A list of intermediate language branch exclusion filters.
        /// </summary>
        public List<string> IntermediateLanguageBranchExclusionFilters { get; private set; }

        /// <summary>
        /// A list of intermediate language conditional branch exclusion filters.
        /// </summary>
        public List<string> IntermediateLanguageConditionExclusionFilters { get; private set; }
