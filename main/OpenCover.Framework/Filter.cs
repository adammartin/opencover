...
namespace OpenCover.Framework
{
    ...
    public interface IFilter
    {
        ...
        /// <summary>
        /// Adds an exclusion for matching method names
        /// </summary>
        /// <param name="methodName"></param>
        void AddMethodExclusion(string methodName);
        ...
        /// <summary>
        /// Enables flag to exclude Lambda auto-generated branches
        /// </summary>
        void ExcludeLambdaAutoGeneratedBranches();
        ...
        bool IsExcludedConditionBranch(InstructionData instructionData);
    ...
    public class Filter : IFilter
    {
        ...
        private readonly IList<MethodExclusion> MethodExclusions = new List<MethodExclusion>(); 
        private readonly IList<BranchExclusion> ExcludedIntermediateLanguageBranch = new List<Filter.BranchExclusion>();
        private bool ShouldExcludeLambdaAutoGeneratedBranches { get; set; }
        ...
        public void ExcludeLambdaAutoGeneratedBranches()
        {
            ShouldExcludeLambdaAutoGeneratedBranches = true;
        }
        ...
        {
            MethodExclusions.Add(new MethodExclusion(methodName));
        }

        public bool IsExcludedConditionBranch(InstructionData instructionData)
        {
            var exclusions = new List<ISkippedBranch>();
            if (ShouldExcludeLambdaAutoGeneratedBranches) exclusions.Add(new LambdaAutogeneratedBranch());
            if (ExcludedIntermediateLanguageConditionBranch.Any()) exclusions.Add(new IntermediateLanguageGeneratedBranch(ExcludedIntermediateLanguageConditionBranch));
            if (MethodExclusions.Any()) exclusions.Add(new ExcludeMethodBranches(MethodExclusions));
            return exclusions.Any(x => x.IsSkipped(instructionData));
        }
        ...
        private void InsertBranchExclusions(string[] parts)
        {
            ...
            ExcludedIntermediateLanguageBranch.Add(new Filter.BranchExclusion(new MethodExclusion(parts[0], parts[1]), branches));
        }
