...
namespace OpenCover.Framework
{
    ...
    public interface IFilter
    {
        ...
        bool IsExcludedConditionBranch(Instruction instruction);
    ...
    public class Filter : IFilter
    {
        ...
        public bool IsExcludedConditionBranch(Instruction instruction)
        {
            ...
            return exclusions.Any(x => x.IsSkipped(instruction));
        }
