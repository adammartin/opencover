...
namespace OpenCover.Test.Framework
{
    ...
    public class CommandLineParserTests
    {
        ...
        [Test]
        public void ExcludeLambdaAutogeneratedBranchesIsFalseByDefault()
        {
            var parser = new CommandLineParser(new[] { RequiredArgs });

            parser.ExtractAndValidateArguments();

            Assert.IsFalse(parser.ExcludeLambdaAutoGeneratedBranches);
        }

        [Test]
        public void HandlesExcludeLambdaAutoGeneratedBranches()
        {
            var parser = new CommandLineParser(new[] { "-excludelambdaautogeneratedbranches", RequiredArgs });

            parser.ExtractAndValidateArguments();

            Assert.IsTrue(parser.ExcludeLambdaAutoGeneratedBranches);            
        }
